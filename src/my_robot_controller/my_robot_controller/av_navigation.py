...
class CarNavigationNode(Node): 
    ...
    def setup_goals(self): 
        self.goal_poses = [ 
        {'x': 3753.4880, 'y': 73689.8906, 'xx': 0.0, 'yy': 0.0, 
                                'zz': 0.2284, 'w': 0.9735}, 
        {'x': 3839.1665, 'y': 73753.2031, 'xx': 0.0, 'yy': 0.0, 
                                'zz': 0.8590, 'w': 0.5118},
        {'x': 3774.3981, 'y': 73729.2812, 'xx': 0.0, 'yy': 0.0, 
                                'zz': -0.5200, 'w': 0.8541},
        {'x': 3788.0852, 'y': 73754.625, 'xx': 0.0, 'yy': 0.0, 
                                'zz': -0.9719, 'w': 0.2353}
        ]
        time.sleep(5) 
        self.publish_goal() 
